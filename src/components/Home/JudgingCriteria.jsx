      ...
      <section className="grid-container section-pad" ref={ref}>
        ...
        <div className={`hidden ${inView ? "show" : ""}`}>
          ...
          <p className="paragraph">
            <span className="accent-2 fw-bold">
          ...
          <p className="paragraph">
            <span className="accent-2 fw-bold">Functionality: </span>
            Assess how well the solution works. Does it perform its intended
            functions effectively and without major issues? Judges would
            consider the completeness and robustness of the solution.
          </p>
          <p className="paragraph">
            <span className="accent-2 fw-bold">Impact and Relevance: </span>
          ...
          <p className="paragraph">
            <span className="accent-2 fw-bold"> Technical Complexity: </span>
